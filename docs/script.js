const translations = {
    ...
    fr: {
        ...
        project4_title: "Moteur de Recherche Googol (SD)",
        project4_desc: "Moteur de recherche distribué avec backend RMI, interface Web Spring Boot, surveillance WebSocket et intégration OpenAI.",
    ...
    nl: {
        ...
        project4_title: "Googol Zoekmachine (SD)",
        project4_desc: "Gedistribueerde zoekmachine met RMI-backend, Spring Boot Web UI, realtime WebSocket-monitoring en OpenAI-integratie.",
    ...
    pt: {
        ...
        project4_title: "Motor de Busca Googol (SD)",
        project4_desc: "Motor de busca distribuído com backend RMI, interface Web Spring Boot, monitorização via WebSockets e integração OpenAI.",
